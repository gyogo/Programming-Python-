...
# random.randrange(1, 7+1)과 같음
print('random.randint(1,7) : ', random.randint(1,7)) #끝이 들어가냐 안들어가냐의 차이
print()
...
print('리스트 순서를 섞기')
print('섞기 전 l =  ',l)
print('random.shufflr(l)')
print('섞은 후 l : ',random.shuffle(l))
print()
